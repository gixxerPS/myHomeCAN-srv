...
function LogicApp(createMaps) {
  ...
  log.debug('shutterMap:');
  log.debug(this.shutterMap);
}
...
LogicApp.prototype.switchShutter = function switchShutter(out_addr, state) {
  ...
  // 'UP' / 'DOWN'
  var mirradr = msghlp.str2IdOffs( this.shutterMap[out_addr].mirrorAdr );
...
LogicApp.prototype.onInputEvent = function onInputEvent(idInfo, uData) {
