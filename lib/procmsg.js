...
var staticOutMap = {};
var i;
//for (i = 0; i < NUM_STATIC_OUT; i++) {
//  staticOut.push({rxid: '', out: new Array(65).join('0')});
//}
...
module.exports = {
    ...
    getAliveMap : function () {
      return mapAlive;
    },
    updateAliveMap : function (idStr, dataObj, cb) {
      mapAlive[idStr] = {
          sw            : dataObj.sw,
          cnt           : dataObj.cnt,
    ...
    parseDataAlive : function (dataStr) {
    ...
    switchOutput : function (offs, state, rxid) {
